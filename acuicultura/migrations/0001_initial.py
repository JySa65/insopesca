...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False, unique=True)),
                ('north_utm', models.FloatField(verbose_name='Norte')),
                ('west_utm', models.FloatField(verbose_name='Este')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateTimeField(auto_now_add=True, verbose_name='Fecha de Inspección')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sistem_cultivate', models.CharField(blank=True, choices=[('mono', 'Mono Cultivo'), ('duo', 'Poli Cultivo')], max_length=50, null=True, verbose_name='Sistema de Cultivo')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
            ],
        ),
